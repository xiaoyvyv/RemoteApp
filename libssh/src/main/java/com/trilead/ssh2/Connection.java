...
public class Connection {
    ...
    private final CryptoWishList cryptoWishList = new CryptoWishList();
    ...
    private final Vector connectionMonitors = new Vector();
     ...
     * @param enable on/off
     */
    public synchronized void enableDebugging(boolean enable) {
